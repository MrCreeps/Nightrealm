...
public class HallowboneHelmetItem extends NightrealmModElements.ModElement {
	@ObjectHolder("nightrealm:hallowbone_helmet")
	public static final Item block = null;

	public HallowboneHelmetItem(NightrealmModElements instance) {
		super(instance, 115);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("hallowbone_helmet");
		}
