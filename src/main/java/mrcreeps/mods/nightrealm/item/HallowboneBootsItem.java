...
public class HallowboneBootsItem extends NightrealmModElements.ModElement {
	@ObjectHolder("nightrealm:hallowbone_boots")
	public static final Item block = null;

	public HallowboneBootsItem(NightrealmModElements instance) {
		super(instance, 118);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("hallowbone_boots");
		}
