...
public class PurifierGUIGui extends NightrealmModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public PurifierGUIGui(NightrealmModElements instance) {
		super(instance, 58);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("purifier_gui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, PurifierGUIGuiWindow::new));
	}
	...
	private static void handleSlotAction(PlayerEntity entity, int slotID, int changeType, int meta, int x, int y, int z) {
		...
		if (slotID == 0 && changeType == 0) {
			...
			CallPurifierProceduresAllProcedure.executeProcedure(Collections.emptyMap());
		}
		...
		if (slotID == 1 && changeType == 1) {
			...
			PurifierClearSlotsProcedure.executeProcedure(Collections.emptyMap());
		}
	}
}
