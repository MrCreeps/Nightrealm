...
public class AbyssalTentacleBlock extends NightrealmModElements.ModElement {
	@ObjectHolder("nightrealm:abyssal_tentacle")
	public static final Block block = null;

	public AbyssalTentacleBlock(NightrealmModElements instance) {
		super(instance, 101);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("abyssal_tentacle"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("nightrealm:abyssal_tentacle"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.SLIME).hardnessAndResistance(0f, 0f)
					.setLightLevel(s -> 3));
			setRegistryName("abyssal_tentacle");
		}
