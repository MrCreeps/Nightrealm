...
public class LumenilBlock extends NightrealmModElements.ModElement {
	@ObjectHolder("nightrealm:lumenil")
	public static final Block block = null;

	public LumenilBlock(NightrealmModElements instance) {
		super(instance, 56);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("lumenil"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("nightrealm:lumenil"), configuredFeature);
		}
	}
