...
public class HallowboneLeavesBlock extends NightrealmModElements.ModElement {
	@ObjectHolder("nightrealm:hallowbone_leaves")
	public static final Block block = null;

	public HallowboneLeavesBlock(NightrealmModElements instance) {
		super(instance, 5);
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.LEAVES).sound(SoundType.GLASS).hardnessAndResistance(0.2f, 0.2f).setLightLevel(s -> 10)
					.notSolid());
			setRegistryName("hallowbone_leaves");
		}
