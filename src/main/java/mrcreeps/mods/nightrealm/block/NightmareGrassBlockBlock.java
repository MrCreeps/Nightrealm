...
public class NightmareGrassBlockBlock extends NightrealmModElements.ModElement {
	@ObjectHolder("nightrealm:nightmare_grass_block")
	public static final Block block = null;

	public NightmareGrassBlockBlock(NightrealmModElements instance) {
		super(instance, 1);
