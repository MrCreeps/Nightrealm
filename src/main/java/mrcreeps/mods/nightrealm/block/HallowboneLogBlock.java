...
public class HallowboneLogBlock extends NightrealmModElements.ModElement {
	@ObjectHolder("nightrealm:hallowbone_log")
	public static final Block block = null;

	public HallowboneLogBlock(NightrealmModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("hallowbone_log");
		}
