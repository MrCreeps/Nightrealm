...
public class ToxicAsterBlock extends NightrealmModElements.ModElement {
	@ObjectHolder("nightrealm:toxic_aster")
	public static final Block block = null;

	public ToxicAsterBlock(NightrealmModElements instance) {
		super(instance, 54);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("toxic_aster"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("nightrealm:toxic_aster"), configuredFeature);
		}
	}
