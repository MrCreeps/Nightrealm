...
public class FrostedCosmosBlock extends NightrealmModElements.ModElement {
	@ObjectHolder("nightrealm:frosted_cosmos")
	public static final Block block = null;

	public FrostedCosmosBlock(NightrealmModElements instance) {
		super(instance, 55);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("frosted_cosmos"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("nightrealm:frosted_cosmos"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("frosted_cosmos");
		}
