...
public class BloodlightHyacinthBlock extends NightrealmModElements.ModElement {
	@ObjectHolder("nightrealm:bloodlight_hyacinth")
	public static final Block block = null;

	public BloodlightHyacinthBlock(NightrealmModElements instance) {
		super(instance, 53);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("bloodlight_hyacinth"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("nightrealm:bloodlight_hyacinth"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("bloodlight_hyacinth");
		}
