...
public class NightmareDirtBlock extends NightrealmModElements.ModElement {
	@ObjectHolder("nightrealm:nightmare_dirt")
	public static final Block block = null;

	public NightmareDirtBlock(NightrealmModElements instance) {
		super(instance, 2);
	}
