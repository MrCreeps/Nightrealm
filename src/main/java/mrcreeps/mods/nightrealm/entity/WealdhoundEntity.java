...
package mrcreeps.mods.nightrealm.entity;
...
import mrcreeps.mods.nightrealm.entity.renderer.WealdhoundRenderer;
import mrcreeps.mods.nightrealm.NightrealmModElements;

@NightrealmModElements.ModElement.Tag
public class WealdhoundEntity extends NightrealmModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1f, 0.8f)).build("wealdhound").setRegistryName("wealdhound");

	public WealdhoundEntity(NightrealmModElements instance) {
		super(instance, 92);
		FMLJavaModLoadingContext.get().getModEventBus().register(new WealdhoundRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -9006685, -14273218, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("wealdhound_spawn_egg"));
	}
